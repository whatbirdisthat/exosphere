 ...
 */
export declare const RULESET_SCHEMA_VERSION = "1.0.0";
/**
 ...
 */
export declare const RULESET_VERSION = "0.7.0";
/**
 ...
 */
export declare const LOCKFILE_SCHEMA_VERSION = "1.0.0";
/**
 ...
 * always (EARS-058).
 */
export declare const ruleSpecs: readonly RuleSpec[];
/**
 ...
 */
export declare const ruleset: readonly Rule[];
