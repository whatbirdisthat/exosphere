...
const C = 'dangerous-bash';
// secret-path-read leaks a credential → Information disclosure.
const SUPPLY_CHAIN = { owasp: 'ASI04', atlas: 'AML.T0011', stride: ['I'] };
// curl|sh / reverse-shell / base64-payload are remote code execution → Tampering + Elevation.
const CMD_EXEC = { owasp: 'ASI04', atlas: 'AML.T0050', stride: ['T', 'E'] };
export const dangerousBashRules = [
    {
