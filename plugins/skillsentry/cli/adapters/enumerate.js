...
const NO_EXCLUSIONS = { excludedCount: 0, patterns: [] };
/**
 ...
 */
export async function enumerateWithIgnore(root, options) {
    ...
    const { kept, summary } = applyIgnore(candidates.map((f) => f.path), ignoreText);
